...
function Graficobarra() {
    ...
    useEffect(() => {
        ...
        axios.get('/api/agricultura')
            .then(res => {
                setAgricultura(res.data[0].agro)
            }).catch(err => console.log(err));


        axios.get('/api/meioambiente')
            .then(res => {
                setMeioambiente(res.data[0].meio)
            }).catch(err => console.log(err));

        axios.get('/api/governo')
            .then(res => {
        ...
        axios.get('/api/codesg')
            .then(res => {
                setCodesg(res.data[0].codesg)
            }).catch(err => console.log(err));

        axios.get('/api/planejamento')
            .then(res => {
            ...
            <div className='containerdashboard'>
                ...
                <div className='main-cards'>
                    ...
                    <div className='card'>
                        ...
                        <hr />
                        <div>
                            <h5>R$: {valorprojeto.toLocaleString('pt-BR', {style:'currency', currency:"BRL"})}</h5>
                        </div>
                    </div>
