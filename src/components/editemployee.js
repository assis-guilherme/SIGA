...
function EditEmployee() {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            await axios.put(`/api/update/${projetocompletoId}`, projetocompleto);
            navigate("/employee");
        } catch (err) {
            console.log(err);
        }
    ...
    return (
        <form className="container">
            <h2>Alterar dados do PROJETO</h2>
 ...
 <Link to="/employee" className='btn btn-warning px-5 g-5 me-2'>Retorna projeto</Link>
                    ...
                    <div className="input-dividido">
                        ...
                        <div className="col">
                            <label className="form-label">Nome do gestor do processo</label>
                            <input type="text"
                                className="form-control"
                                placeholder='Digite o nome do gestor do projeto'
                                name="gestorprocesso"
                                value={projetocompleto.gestorprocesso} onChange={handleChange} />
                        </div>
                    </div>
                    ...
                    <div className="col">
                            ...
                            <input type="text"
                                ...
                                autoComplete='off'
                                name="descricao"
                                value={projetocompleto.descricao} onChange={handleChange} />
                        </div>

                    <div className="input-dividido">
                        <div className="col">
                            <label className="form-label">Valor estimado do projeto</label>
                            <input type="number"
                                className="form-control"
                                placeholder='Digite o valor estimado do projeto'
                                autoComplete='off'
                                name="valor"
                                value={projetocompleto.valor} onChange={handleChange} />
                        </div>

                        <div className="col">
                            <label className="form-label">Ano de início do projeto</label>
                            <input type="number"
                                className="form-control"
                                placeholder='Digite o ano de início do projeto'
                                name="ano"
                                value={projetocompleto.ano} onChange={handleChange} />
                        </div>
                    </div>
